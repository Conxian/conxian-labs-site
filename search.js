...
(function() {
  var PAGES = [
    ...
    { title: 'Business Operating System (BOS)', desc: 'Sovereign Autonomous Business execution engine, state orchestration, and enterprise workflow governance.', url: 'enterprise/index.html', keywords: 'bos business operating system sovereign autonomous business sab execution workflow orchestration' },
    { title: 'Conxian Nexus — Risk Oracle', desc: 'Decentralized risk oracle, real-time verification, compliance monitoring, and cross-chain state proof layer.', url: 'research/index.html', keywords: 'nexus risk oracle decentralized oracle verification compliance state proofs proof layer' },
    { title: 'Gateway — Fusion & Sentinel', desc: 'High-throughput API middleware, unified JWT/Enclave authentication (Fusion), and secret filtering (Sentinel).', url: 'docs/index.html', keywords: 'gateway fusion sentinel authentication jwt enclave secret filtering middleware api' },
    { title: 'Conxian Market — Settlement Engine', desc: 'Nakamoto-ready settlement engine, sovereign asset exchange, and liquidity pool state management.', url: 'commercial/index.html', keywords: 'market settlement nakamoto sovereign asset exchange liquidity pool execution engine' },
    { title: 'Corelibs — Cryptographic Primitives', desc: 'Shared cryptographic primitives, security specifications, and core protocol libraries (lib-conxian-core).', url: 'docs/index.html', keywords: 'corelibs lib-conxian-core cryptographic primitives cryptography security specifications rust' },
