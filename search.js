...
(function() {
  var PAGES = [
    ...
    { title: 'Commercial Brief', desc: 'Executive buyer brief for Gateway, Wallet, Conxius Enclave SDK, and Core, with current readiness boundaries, evaluation paths, and proof links.', url: 'commercial/index.html', keywords: 'commercial buyer executive brief gateway wallet sdk conxius enclave core readiness maturity boundaries evaluate proof evidence pilot enterprise' },
    { title: 'Scoped Pilot Brief', desc: 'Bounded pilot narrative with scope, customer inputs, measurable success criteria, evidence checkpoints, non-goals, stages, and exit paths.', url: 'commercial/pilot/index.html', keywords: 'pilot scoped pilot buyer customer inputs success criteria evidence checkpoints stages duration bounded non-goals exit paths gateway wallet sdk core' },
    ...
    { title: 'Enterprise', desc: 'Deployment discovery, governance, and scoped support for Gateway, Wallet, Conxius Enclave SDK, and Core.', url: 'enterprise/index.html', keywords: 'enterprise institutional sovereign deployment solutions business regulated' },
